...
export default function AnnouncementsListPage() {
  ...
  return (
    <div className='bg-white p4 rounded-md flex-1 border-4 m-4 mt-0'>
      ...
      <div className="flex items-center justify-between p-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full md:w-auto" >
          ...
          <div className="flex items-center gap-4 mt-2 mr-2">
            ...
            <button onClick={() => {setTrial((prev) => prev += 1)}} className="button3 w-8 flex items-center justify-center rounded-full bg-yellow-400" >
      ...
      {/* List section */}
      <Table columns={columns} row={renderRow} data={announcementsData}/>
      {/* Pagination */}
      <Pagination />
    </div>
  )
